	...
	Cloneable, Shape
{
	...
	float radius = 4;
		float x, y, r2;
		float xCenter = (float) (tip.x - (radius * Math.cos(theta)));
		float yCenter = (float) (tip.y - (radius * Math.sin(theta)));

		// A simple circle algorithm
//		r2 = radius * radius;
//		path.lineTo(xCenter, yCenter + radius);
//		path.lineTo(xCenter, yCenter - radius);
//		for (x = 1; x <= radius; x++) {
//			y = (int) (Math.sqrt(r2 - x * x) + 0.5);
//			path.lineTo(xCenter + x, yCenter + y);
//			path.lineTo(xCenter + x, yCenter - y);
//			path.lineTo(xCenter - x, yCenter + y);
//			path.lineTo(xCenter - x, yCenter - y);
//		}
		
		// 8-point circle symmetry
        r2 = radius * radius;
        path.lineTo(x=xCenter, y=yCenter + radius);
        testpath.lineTo(x,y);
        path.lineTo(x=xCenter, y=yCenter - radius);
        testpath.lineTo(x,y);
        path.lineTo(x=xCenter + radius, y=yCenter);
        testpath.lineTo(x,y);
        path.lineTo(x=xCenter - radius, y=yCenter);
        testpath.lineTo(x,y);
        x = 1;
        ...
        while (x < y) {
        	...
        	path.lineTo(xCenter - x, yCenter + y);
        	path.lineTo(xCenter - x, yCenter - y);
        	path.lineTo(xCenter + y, yCenter + x);
        	path.lineTo(xCenter + y, yCenter - x);
        	path.lineTo(xCenter - y, yCenter + x);
        	path.lineTo(xCenter - y, yCenter - x);
        	x += 1;
