...
public class JoinedProcessesGraphTest extends JFrame
{
	/**
	 * 
	 */
	...
	public JoinedProcessesGraphTest()
	{
	...
	public void joinProcessesFromJson(String json) {
		try {
			ProcessPort port = ProcessPort.fromJson(json);
			if (port != null) {
				...
				port.joinVertices(graph, pa, false, false, v1, v2);
				graph.layout();
			}
	...
	{
		setLookAndFeel();
		JoinedProcessesGraphTest gui = new JoinedProcessesGraphTest();
		gui.setup();

		// `A:LinProp`;;
		gui.joinProcessesFromJson("{ \"channel\": \"cPa_A_1\", \"cll\": { \"type\": \"var\", \"name\": \"A\" } }");
		// `A ++ C`;;
		gui.joinProcessesFromJson("{\n      \"channel\": \"cPx_lB_A_Plus_C_rB_1\",\n      \"cll\": {\n        \"type\": \"plus\",\n        \"args\": [\n          { \"type\": \"var\", \"name\": \"A\" },\n          { \"type\": \"var\", \"name\": \"C\" }\n        ]\n      }\n    }");
		// `D ++ (E ** G)`;;
